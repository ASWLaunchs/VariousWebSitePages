...
CREATE TABLE `user` (
  ...
  `password` int(15) NOT NULL COMMENT '密码',
  `sex` varchar(6) NOT NULL COMMENT '性别',
  `age` int(3) NOT NULL COMMENT '年龄',
  `favor` varchar(20) NOT NULL COMMENT '爱好',
...
INSERT INTO `user` VALUES (1,'等等','皇贵妃',123456,'女',25,'阅读 旅行','云南','我是太子的新妈妈');
...
-- Dump completed on 2020-05-28  21:33:11
